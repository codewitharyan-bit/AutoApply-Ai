...
export default function SignUpPage() {
  return (
    <div className="relative min-h-screen overflow-y-auto bg-[#09090B] md:h-screen md:overflow-hidden">
      ...
      <div className="relative flex min-h-screen flex-col md:h-full md:flex-row">
        {/* Brand panel - 50% (hidden on mobile) */}
        <div className="hidden md:flex items-center justify-center md:h-full md:w-1/2 px-6 py-4 md:py-0 md:px-8">
        ...
        {/* Auth panel - 50% */}
        <div className="flex items-center justify-center md:h-full md:w-1/2 px-6 py-8 md:py-0 md:px-8 md:pt-12">
          <div className="w-full max-w-[460px] mt-15">
            {/* Mobile header */}
            <div className="mb-4 text-center md:hidden">
              ...
              <h1 className="text-base font-bold text-[#FAFAFA]">Create your account</h1>
              <p className="mt-0.5 text-[10px] text-[#A1A1AA]">Start automating your job applications</p>
            </div>
            ...
            >
              <div className="rounded-2xl border border-[rgba(255,255,255,0.08)] bg-white/[0.03] p-4 backdrop-blur-sm">
                {/* Desktop header */}
                <div className="mb-2 hidden md:block">
                  <h2 className="text-base font-bold text-[#FAFAFA]">Create your account</h2>
                  <p className="mt-0.5 text-[10px] text-[#A1A1AA]">Start automating your job applications</p>
                </div>
                  ...
                  appearance={{
                    elements: {
                      ...
                      socialButtonsBlockButton:
                        'flex w-full items-center justify-center gap-2 rounded-lg border border-[rgba(255,255,255,0.12)] bg-[#09090B] px-2.5 py-1 text-[10px] font-medium text-[#FAFAFA] transition-all duration-200 hover:bg-[#12121A] hover:border-[rgba(255,255,255,0.2)] hover:shadow-[0_0_10px_rgba(99,102,241,0.08)]',
                      socialButtonsBlockButtonText: 'text-[#FAFAFA] text-[10px] font-medium',
                      socialButtonsBlockButtonArrow: 'text-[#A1A1AA]',
                      dividerLine: 'bg-[rgba(255,255,255,0.08)]',
                      dividerText: 'text-[#52525B] text-[9px] font-medium',
                      formFieldLabel: 'block text-[10px] font-medium text-[#A1A1AA] mb-0.5',
                      formFieldInput:
                        'w-full rounded-lg border border-[rgba(255,255,255,0.12)] bg-[#09090B] px-2.5 py-1 text-[10px] text-[#FAFAFA] placeholder-[#52525B] transition-all duration-200 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none focus:shadow-[0_0_8px_rgba(99,102,241,0.1)]',
                      formFieldInputShowPasswordButton: 'text-[#A1A1AA] hover:text-[#FAFAFA]',
                      formButtonPrimary:
                        'w-full rounded-lg bg-primary px-2.5 py-1 text-[10px] font-medium text-white transition-all duration-200 hover:bg-primary/90 hover:shadow-[0_0_15px_rgba(99,102,241,0.3)] active:scale-[0.98]',
                      formFieldErrorText: 'text-red-400 text-[10px] mt-0.5',
                      footerAction: 'mt-1.5 flex items-center justify-center gap-1 text-[10px]',
                      footerActionText: 'text-[10px] text-[#A1A1AA]',
                      footerActionLink: 'text-[10px] font-medium text-primary transition-colors duration-200 hover:text-primary/80 hover:underline',
                      identityPreviewText: 'text-[#FAFAFA] text-[10px]',
                      identityPreviewEditButton: 'text-primary text-[10px] font-medium hover:text-primary/80',
                      otpCodeFieldInput:
                        'border border-[rgba(255,255,255,0.12)] bg-[#09090B] text-[#FAFAFA] rounded-lg w-full h-7 text-center text-[10px] focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none',
                      alternativeMethodsBlockButton:
                        'text-[#A1A1AA] text-[10px] border border-[rgba(255,255,255,0.12)] rounded-lg px-2.5 py-0.5 hover:bg-[#12121A] hover:text-[#FAFAFA] transition-all duration-200',
                      backLink: 'text-[#A1A1AA] text-[10px] hover:text-[#FAFAFA] transition-colors duration-200',
                      formFieldAction: 'text-primary text-[9px] font-medium hover:text-primary/80',
                      formHeaderTitle: 'text-[#FAFAFA] text-sm font-semibold',
                      formHeaderSubtitle: 'text-[#A1A1AA] text-[10px]',
                      socialButtonsProviderIcon: 'h-3.5 w-3.5',
                      alert: 'rounded-lg border border-red-500/20 bg-red-500/10 px-2.5 py-1 text-[10px] text-red-400',
                      alertText: 'text-[10px] text-red-400',
                      alertIcon: 'text-red-400',
                      formResendCodeLink: 'text-primary text-[10px] font-medium hover:text-primary/80',
                    },
                  }}
                />

                <p className="mt-2 text-center text-[8px] text-[#52525B]">
